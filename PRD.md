...
> **현재 버전**: v1.1.0  
> **최신 PRD**: [PRD/v1.1.0.md](./PRD/v1.1.0.md)

이 파일은 호환성을 위해 유지됩니다. 최신 버전은 PRD 디렉토리를 참조하세요.

---

# 포커스팟 (FocusSpot) - 레거시 버전
...
- **간접 이해관계자**: 카페 점주, 지도 데이터 API 제공사(네이버/카카오).
...
- **외부 서비스**: 위치 표시를 위한 네이버/카카오 지도 API 및 길 찾기 연동 서비스.
